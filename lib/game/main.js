...
.requires(
	...
	'game.entities.breathInstructionText'
	//debug
	//'impact.debug.debug'
)
.defines(function(){
...
MyGame = ig.Box2DGame.extend({
	...
	init: function() {
		...
		this.instructionText = ig.game.spawnEntity( EntityBreathInstructionText , ig.system.width / 2 , 100 );
	...
	handleMouseInput: function() {
		...
		var createIndicator = function(isTryAgain){
			...
			that.breathIndicator =
				ig.game.spawnEntity( EntityBreathIndicator,
					ig.system.width / 2,
