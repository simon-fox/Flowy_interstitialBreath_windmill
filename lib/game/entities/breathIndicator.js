...
var definesFunction = function(){
    var objectDefinition = {
        ...
        init: function(x, y, settings){
            ...
            var yText = y > ig.system.height / 2
                ...
                : y + this._maxRadius * Dimensions.textDistanceCoef;
            this._text = ig.game.spawnEntity(EntityBreatheText, xText, yText);
    ...
    EntityBreathIndicator = ig.Entity.extend(objectDefinition);
};

/* The actual impact entity module declaration */
ig.module('game.entities.breathIndicator').requires('impact.entity').defines(definesFunction);
